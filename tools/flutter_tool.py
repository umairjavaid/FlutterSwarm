...
class FlutterTool(BaseTool):
    ...
    async def _create_project(self, project_name: str, template: str = "app", 
        ...
        """Create a new Flutter project - ZERO custom code, only basic structure."""
        # Only create the basic Flutter project structure using flutter create command
        # ALL custom code must be generated by implementation agents using LLMs
        ...
        if result.status == ToolStatus.SUCCESS:
            ...
            result.data = {
                ...
                "template": template,
                "organization": org,
                "note": "Basic Flutter project created. ALL custom code must be generated by implementation agents using LLMs - ZERO hardcoded templates allowed."
            }
