...
''';
    ...
    def _determine_project_type(self, project) -> str:
        ...
        if 'weather' in name_lower or 'weather' in requirements_text:
            return "weather"
        elif 'music' in name_lower or 'music' in requirements_text:
            return "music"
        else:
            return "basic"
    
    async def _create_weather_app_structure(self, project_path: str, project) -> List[str]:
        """Create a comprehensive weather app structure."""
        files_created = []
...
void main() {{
  runApp(const WeatherMasterApp());
}}

class WeatherMasterApp extends StatelessWidget {{
...
'''
        ...
        # Home screen with weather-specific UI
        home_screen_content = '''import 'package:flutter/material.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final temps = ['24°/18°', '26°/19°', '22°/16°', '25°/20°', '23°/17°'];
          final icons = [Icons.wb_sunny, Icons.cloud, Icons.grain, Icons.wb_sunny, Icons.cloud];
          
          return Card(
            margin: const EdgeInsets.only(bottom: 12),
            child: ListTile(
              leading: Icon(icons[index], size: 40, color: Colors.blue.shade700),
